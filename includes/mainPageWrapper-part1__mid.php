<div class="mainPageWrapper-part1__mid">
	...
	<a href="<?php the_permalink(); ?>" class="mainPageWrapper-part1__center" style="background: linear-gradient(0deg, #003526 13.95%, rgba(255, 255, 255, 0) 100%),url('<?php the_post_thumbnail_url() ?>') 50%, no-repeat;">
		<div>
