  ...
  <div class="container">
    ...
    <div class="events">
			...
			<div class="horizontalBar horizontalBar1">
				<?php echo do_shortcode('[events_list scope="all" limit=4 offset=0 orderby="event_start_date" order="DESC"]
				<div>
					<div>
			...
			<div class="horizontalBar horizontalBar2">
				<?php echo do_shortcode('[events_list scope="all" limit=4 offset=4 orderby="event_start_date" order="DESC"]
				<div>
					<div>
						<a href="#_EVENTURL" class="horizontalBarFirst imgBlock">
							<img src="#_EVENTIMAGEURL">
